function[results]=boun_Caputo_derivative(a,b,i,fic_point_No,global_x,global_y,direction)
    global d_x
    global d_y
    ...
    if(direction==1)
        ...
        for k=1:1:n
            ...
            if(k==1)
                ...
                elseif(k==n)
                   result_x=result_x+in_deri_x_disp_x(i,fic_point_No);
                   result_y=result_y+in_deri_x_disp_y(i,fic_point_No);
                end
            elseif(k<n)
            ...
            elseif(k==n)
                ...
                result_x=result_x+coeff*in_deri_x_disp_x(i,fic_point_No);
                result_y=result_y+coeff*in_deri_x_disp_y(i,fic_point_No);
            end
        end
    elseif(direction==2)
        right_posi=b(1);
    ...
    elseif(direction==3)
        ...
        for k=1:1:n
            ...
            if(k==1)
                ...
                elseif(k==n)
                    result_x=result_x+in_deri_y_disp_x(i,fic_point_No);
                    result_y=result_y+in_deri_y_disp_y(i,fic_point_No);
                end
            elseif(k<n)
            ...
            elseif(k==n)
                ...
                coeff_1=t_n-t_minus1;
                coeff=coeff_1^(1-alpha)/gamma(3-alpha);
                result_x=result_x+coeff*in_deri_y_disp_x(i,fic_point_No);
                result_y=result_y+coeff*in_deri_y_disp_y(i,fic_point_No);
            end
        end
    elseif(direction==4)
        upper_posi=b(1);
