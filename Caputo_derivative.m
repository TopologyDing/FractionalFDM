function[results]=Caputo_derivative(b,i,j,direction)
        ...
        for k=1:1:n
            ...
            if(k==1)
                if(k~=n)
                   ...
                   result_x=result_x+coeff*one_order_disp_gradient_x(cur_posi_x,j,1);
                   result_y=result_y+coeff*one_order_disp_gradient_x(cur_posi_x,j,2);
                elseif(k==n)
                   result_x=result_x+one_order_disp_gradient_x(cur_posi_x,j,1);
                   result_y=result_y+one_order_disp_gradient_x(cur_posi_x,j,2);
                end
            elseif(k<n)
        ...
        for k=1:1:n
            ...
            if(k==1)
                if(k~=n)
                    ...
                    %if current point on the boundary
                    if(on_boundary==1)
                        s=out_fic_index(cur_posi_x-1,j);
                        for r=1:1:2
                            if(out_dir_index(s,r)==1)
                                result_x=result_x+coeff*in_deri_x_disp_x(s,r);
                                result_y=result_y+coeff*in_deri_x_disp_y(s,r);
                                break;
                            end
                        end
                    else
        ...
        for k=1:1:n
            ...
            if(k==1)
                if(k~=n)
                    ...
                    result_x=result_x+coeff*one_order_disp_gradient_y(m,cur_posi_y,1);
                    result_y=result_y+coeff*one_order_disp_gradient_y(m,cur_posi_y,2);
                elseif(k==n)
                    result_x=result_x+one_order_disp_gradient_y(m,cur_posi_y,1);
                    result_y=result_y+one_order_disp_gradient_y(m,cur_posi_y,2);
                end
            elseif(k<n)
        ...
        for k=1:1:n
            ...
            if(k==1)
                if(k~=n)
                    ...
                    if(on_boundary==1)
                        s=out_fic_index(m,cur_posi_y-1);
                        for r=1:1:2
                            if(out_dir_index(s,r)==2)
                                result_x=result_x+coeff*in_deri_y_disp_x(s,r);
                                result_y=result_y+coeff*in_deri_y_disp_y(s,r);
                                break;
                            end
                        end
                    else
