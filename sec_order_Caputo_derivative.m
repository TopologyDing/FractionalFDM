function[results]=sec_order_Caputo_derivative(b,i,j,direction)
        ...
        for k=1:1:n
            ...
            if(k==1)
                if(k~=n)
                    ...
                    result_x=result_x+coeff*disp_gradient_y(m,cur_posi_y,1);
                    result_y=result_y+coeff*disp_gradient_y(m,cur_posi_y,2);
                elseif(k==n)
                    result_x=result_x+disp_gradient_y(m,cur_posi_y,1);
                    result_y=result_y+disp_gradient_y(m,cur_posi_y,2);
                end
            elseif(k<n)
